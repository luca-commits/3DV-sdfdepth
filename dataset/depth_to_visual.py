...
def waymo_eval_vis():
    base_path = "/home/casimir/ETH/kitti/waymo_visuals/depth"
    output_path = "/home/casimir/ETH/kitti/waymo_visuals/visual"
...
def folder_vis(scale=1.0):
    base_path = "/home/casimir/ETH/kitti/waymo_visuals/original/depth"
    output_path = "/home/casimir/ETH/kitti/waymo_visuals/original/visual"
    ...
    for rgb_dir in tqdm(rgb_dirs):
        ...
        # img_np = img_np / 256.0
        img = media.to_rgb(img_np, cmap="viridis", vmin=0.0, vmax=80.0)
        media.write_image(f"{output_path}/{os.path.basename(rgb_dir)}", img)
